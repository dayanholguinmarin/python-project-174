...
🚀 Uso básico
Comparación de dos archivos JSON Y YAML:
python3 -m gendiff.scripts.cli tests/fixtures/file1.yml tests/fixtures/file2.json --format stylish o plain o json
python3 -m gendiff.scripts.cli tests/fixtures/file1.yml tests/fixtures/file2.yml --format stylish o plain o json
